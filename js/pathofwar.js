...
function exporter(){
 ...
 function loadData(){
	...
	for (i = 0; i < size; i++) {
        ...
        /*
$(node).find(".type img").dblclick(function() {

            $(this).parent().parent().parent().toggleClass('card smallCard');
        });
        $(node).find(".action img").dblclick(function() {

            $(this).parent().parent().parent().children(".cover").toggleClass('black white');

        });


        */
		$(node).find(".title").dblclick(function() {
			
			$(this).parent().parent().toggleClass('card smallCard');
		});
		$(node).find(".content").dblclick(function() {
	
			$(this).parent().children(".cover").toggleClass('black white');
